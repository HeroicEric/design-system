...
class HdsAppHeaderHomeLinkComponent extends Component {
  get ariaLabel() {
    const {
      ariaLabel
    } = this.args;
...
setComponentTemplate(TEMPLATE, HdsAppHeaderHomeLinkComponent);

export { HdsAppHeaderHomeLinkComponent as default };
