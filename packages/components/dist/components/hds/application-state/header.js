...
class HdsApplicationStateHeaderComponent extends Component {
  get titleTag() {
    return this.args.titleTag ?? HdsApplicationStateTitleTagValues.Div;
  }
}
setComponentTemplate(TEMPLATE, HdsApplicationStateHeaderComponent);

export { HdsApplicationStateHeaderComponent as default };
