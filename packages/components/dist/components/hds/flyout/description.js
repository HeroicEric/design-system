...
class HdsFlyoutDescriptionComponent extends Component {
  constructor(owner) {
    super(owner, {});
...
setComponentTemplate(TEMPLATE, HdsFlyoutDescriptionComponent);

export { HdsFlyoutDescriptionComponent as default };
