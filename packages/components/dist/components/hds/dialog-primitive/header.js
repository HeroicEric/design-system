...
const NOOP = () => {};
class HdsDialogPrimitiveHeaderComponent extends Component {
  /**
   * @param onDismiss
   * @type {function}
   * @default () => {}
...
setComponentTemplate(TEMPLATE, HdsDialogPrimitiveHeaderComponent);

export { HdsDialogPrimitiveHeaderComponent as default };
