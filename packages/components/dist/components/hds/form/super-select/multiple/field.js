...
class HdsFormSuperSelectMultipleFieldComponent extends Component {
  get idPrefix() {
    return ID_PREFIX;
  }
}
setComponentTemplate(TEMPLATE, HdsFormSuperSelectMultipleFieldComponent);

export { HdsFormSuperSelectMultipleFieldComponent as default };
