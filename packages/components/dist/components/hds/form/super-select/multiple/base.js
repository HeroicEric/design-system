...
let HdsFormSuperSelectMultipleBaseComponent = (_class = class HdsFormSuperSelectMultipleBaseComponent extends Component {
  constructor(...args) {
    super(...args);
...
setComponentTemplate(TEMPLATE, HdsFormSuperSelectMultipleBaseComponent);

export { DEFAULT_HORIZONTAL_POSITION, HORIZONTAL_POSITION_MAPPING, HdsFormSuperSelectMultipleBaseComponent as default };
