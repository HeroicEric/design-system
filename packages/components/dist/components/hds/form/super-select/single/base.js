...
let HdsFormSuperSelectSingleBaseComponent = (_class = class HdsFormSuperSelectSingleBaseComponent extends Component {
  constructor(...args) {
    super(...args);
...
setComponentTemplate(TEMPLATE, HdsFormSuperSelectSingleBaseComponent);

export { DEFAULT_HORIZONTAL_POSITION, HORIZONTAL_POSITION_MAPPING, HdsFormSuperSelectSingleBaseComponent as default };
