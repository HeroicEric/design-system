...
class HdsFormSuperSelectOptionGroupComponent extends Component {
  constructor(...args) {
    super(...args);
    /**
...
setComponentTemplate(TEMPLATE, HdsFormSuperSelectOptionGroupComponent);

export { HdsFormSuperSelectOptionGroupComponent as default };
