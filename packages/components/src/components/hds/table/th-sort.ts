...
import {
  HdsTableHorizontalAlignment as HdsTableHorizontalAlignmentValues,
  HdsTableThSortOrder as HdsTableThSortOrderValues,
  HdsTableThSortOrderLabels as HdsTableThSortOrderLabelsValues,
} from './types.ts';
  ...
  get ariaSort(): HdsTableThSortOrderLabels {
    switch (this.args.sortOrder) {
      case HdsTableThSortOrderValues.Asc:
        return HdsTableThSortOrderLabelsValues.Asc;
      case HdsTableThSortOrderValues.Desc:
        return HdsTableThSortOrderLabelsValues.Desc;
      default:
        // none is the default per the spec.
        return HdsTableThSortOrderLabelsValues.None;
    }
  }
